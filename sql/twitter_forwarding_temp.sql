...
CREATE TABLE IF NOT EXISTS `mydb`.`Following` (
  `Users_idUsers_followed` INT NOT NULL,
  `Users_idUsers_follower` INT NOT NULL,
  INDEX `fk_Following_Users1_idx` (`Users_idUsers_followed` ASC),
  INDEX `fk_Following_Users2_idx` (`Users_idUsers_follower` ASC),
  CONSTRAINT `fk_Following_Users1`
    FOREIGN KEY (`Users_idUsers_followed`)
    REFERENCES `mydb`.`Users` (`idUsers`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Following_Users2`
    FOREIGN KEY (`Users_idUsers_follower`)
    REFERENCES `mydb`.`Users` (`idUsers`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `test`.`b_fuel`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test`.`b_fuel` (
  `HeatFuel` TEXT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `test`.`b_fueltype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test`.`b_fueltype` (
  `HeatType` TEXT NULL DEFAULT NULL,
  `FID` INT(11) NULL DEFAULT NULL)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `test`.`b_housearea`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test`.`b_housearea` (
  `TotalGrossArea` INT(11) NULL DEFAULT NULL,
  `FID` INT(11) NULL DEFAULT NULL)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `test`.`b_housevalue`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test`.`b_housevalue` (
...
-- -----------------------------------------------------
-- Table `test`.`b_houseyear`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test`.`b_houseyear` (
  `YearBlt` INT(11) NULL DEFAULT NULL,
  `FID` INT(11) NULL DEFAULT NULL)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- Table `test`.`b_street`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test`.`b_street` (
  `StreetName` INT(11) NULL DEFAULT NULL,
  `FID` INT(11) NULL DEFAULT NULL)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
USE `sys`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`version` AS select '1.5.1' AS `sys_version`,version() AS `mysql_version`;
